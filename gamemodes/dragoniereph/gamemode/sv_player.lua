...
addModel("barney", "male")
addModel("breen", "male")
addModel("eli", "male")
addModel("gman", "male")
addModel("kleiner", "male")
addModel("monk", "male")
addModel("odessa", "male")
addModel("police", "male")
addModel("alyx", "female")
addModel("chell", "female")
addModel("mossman", "female")
addModel("mossmanartic", "female")
addModel("policefem", "female")
addModel("medic15", "female")
addModel("css_guerilla", "male")
addModel("combineprison", "male")
addModel("skeleton", "male")
addModel("combineelite", "male")
...
function GM:PlayerCanHearChatVoice( listener, talker, typ, teamOnly )
	...
	// if the player is dead or a spectator we cant hear them
