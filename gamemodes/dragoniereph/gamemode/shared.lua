local tabFile = file.Read(GM.Folder .. "/dragoniereph.txt", "GAME") or ""
local tab = util.KeyValuesToTable(tabFile)

GM.Name 	= tab["title"] or "Prop Hunters : One For All - Dragonière Edition"
GM.Author 	= "Davidcicode, Neottrox, Zikaeroh, MechanicalMind"
