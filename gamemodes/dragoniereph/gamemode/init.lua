...
resource.AddFile("materials/melonbomber/license.txt")
...
GM.AutoTauntEnabled = GetConVar("ph_auto_taunt")
GM.AutoTauntMin = GetConVar("ph_auto_taunt_delay_min")
GM.AutoTauntMax = GetConVar("ph_auto_taunt_delay_max")
