...
function GM:ScoreboardShow()
	if IsValid(menu) then
		...
		function menu.Credits:Paint(w, h) 
			...
			draw.ShadowText("by Neottrox and Davidcicode, " .. tostring(GAMEMODE.Version or "error") .. " (originally by MechanicalMind, modified by Zikaeroh)", "RobotoHUD-L15", 4 + tw + 24, h  * 0.9, Color(220, 220, 220), 0, 4)
		end
