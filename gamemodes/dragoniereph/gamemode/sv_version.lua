local downloadlinks = "https://steamcommunity.com/sharedfiles/filedetails/?id=2397909729"
...
concommand.Add("ph_version", function (ply)
	...
	t:Add(n .. " by Neottrox and Davidcicode, " .. tostring(GAMEMODE.Version or "error") .. " (originally by MechanicalMind, Zikaeroh)\n", Color(255, 149, 129))
	if IsValid(ply) then
		t:Send(ply)
	else
		t:Print()
